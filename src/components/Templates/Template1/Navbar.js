                        ...
                        <div className=" flex items-center justify-between">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    <div className='w-32  bg-[#00a0e6] text-center  rounded-full px-4 py-2 text-white'
                                    >
                                        Try for free
                                    </div>

                                    <div className=' bg-[#212e4e] w-32 text-center text-white rounded-full px-4 py-2'
                                    >
                                        Log In
                                    </div>
                                </div>
                    ...
                    {(ref) => (
                        <div className="mt-10 md:hidden" id="mobile-menu">
                            <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col items-start">
                                <div
                                    className="navbar__small bg-[#00a0e6] text-white rounded-md  font-semibold"
                                >
