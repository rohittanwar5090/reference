                    ...
                    <div className="h-20">
                        <div className=" flex items-center justify-between">
                            <div className={`-mt-7 lg:mt-0 flex-shrink-0 cursor-pointer ${bgWhite && 'bg-white px-2 rounded '}`}>
                                <Link to='/'>
                                    <img src='/images/template2/template1-logo.png' className='mt-5 md:mt-0 w-40 pb-3 ' alt="logo" />
                                </Link>
                            </div>
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    <div className='w-32 text-center bg-[#00a0e6] rounded-full px-4 py-2 text-black'
                                    >
                                        Try for free
                                    </div>
                    ...
                    {(ref) => (
                        <div className="mt-10 md:hidden" id="mobile-menu">
                            <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col items-start">
                                <div
                                    className="navbar__small text-black bg-[#00a0e6] rounded-md  font-semibold"
                                >
                                    <p className='inline-block'>Try for free</p>
                                </div>

                                <div
                                    className="navbar__small text-white bg-[#212e4e] rounded-md font-semibold"
                                >
